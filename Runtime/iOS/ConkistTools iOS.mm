...
@interface UShareEmailItemProvider : NSObject <UIActivityItemSource>
@property (nonatomic, strong) NSString *subject;
@property (nonatomic, strong) NSString *body;
@end

// Credit: https://stackoverflow.com/a/29916845/2373034
@implementation UShareEmailItemProvider
...
extern "C" void _Share_Share( const char* files[], int filesCount, const char* subject, const char* text, const char* link ) 
{
	NSMutableArray *items = [NSMutableArray new];
	
	// When there is a subject on iOS 7 or later, text is provided together with subject via a UShareEmailItemProvider
	// Credit: https://stackoverflow.com/a/29916845/2373034
	if( strlen( subject ) > 0 && CHECK_IOS_VERSION( @"7.0" ) )
	{
		UShareEmailItemProvider *emailItem = [UShareEmailItemProvider new];
