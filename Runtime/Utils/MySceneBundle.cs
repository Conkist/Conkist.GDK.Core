...
namespace Conkist.GDK.Utils
{
	...
	public static class MySceneBundle
	{
		...
		static MySceneBundle()
		{
			...
			UnityEngine.SceneManagement.SceneManager.sceneUnloaded += PrepareSceneBundleForNextSceneByTransferOptions;
		}
		...
		{
			return UnityEngine.SceneManagement.SceneManager.sceneCount == 2;
		}
