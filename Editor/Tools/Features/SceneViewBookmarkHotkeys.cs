...
namespace Conkist.GDK.Tools.Internal
{
	...
	internal static class SceneViewBookmarkHotkeys
	{
		...
		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 1 &1", false, 5000)]
		private static void BookmarkSceneView1()
		{
			BookmarkSceneView(1);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 2 &2", false, 5000)]
		private static void BookmarkSceneView2()
		{
			BookmarkSceneView(2);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 3 &3", false, 5000)]
		private static void BookmarkSceneView3()
		{
			BookmarkSceneView(3);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 4 &4", false, 5000)]
		private static void BookmarkSceneView4()
		{
			BookmarkSceneView(4);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 5 &5", false, 5000)]
		private static void BookmarkSceneView5()
		{
			BookmarkSceneView(5);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 6 &6", false, 5000)]
		private static void BookmarkSceneView6()
		{
			BookmarkSceneView(6);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 7 &7", false, 5000)]
		private static void BookmarkSceneView7()
		{
			BookmarkSceneView(7);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 8 &8", false, 5000)]
		private static void BookmarkSceneView8()
		{
			BookmarkSceneView(8);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Bookmark Scene View 9 &9", false, 5000)]
		private static void BookmarkSceneView9()
		{
			BookmarkSceneView(9);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 1 #1", false, 5001)]
		private static void MoveSceneViewToBookmark1()
		{
			RestoreSceneBookmark(1);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 2 #2", false, 5001)]
		private static void MoveSceneViewToBookmark2()
		{
			RestoreSceneBookmark(2);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 3 #3", false, 5001)]
		private static void MoveSceneViewToBookmark3()
		{
			RestoreSceneBookmark(3);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 4 #4", false, 5001)]
		private static void MoveSceneViewToBookmark4()
		{
			RestoreSceneBookmark(4);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 5 #5", false, 5001)]
		private static void MoveSceneViewToBookmark5()
		{
			RestoreSceneBookmark(5);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 6 #6", false, 5001)]
		private static void MoveSceneViewToBookmark6()
		{
			RestoreSceneBookmark(6);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 7 #7", false, 5001)]
		private static void MoveSceneViewToBookmark7()
		{
			RestoreSceneBookmark(7);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 8 #8", false, 5001)]
		private static void MoveSceneViewToBookmark8()
		{
			RestoreSceneBookmark(8);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 9 #9", false, 5001)]
		private static void MoveSceneViewToBookmark9()
		{
			RestoreSceneBookmark(9);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Return To Previous Scene View #0", false, 5002)]
		...
		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 1 #1", true)]
		private static bool ValidateMoveSceneViewToBookmark1()
		{
			return BookmarkExists(1);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 2 #2", true)]
		private static bool ValidateMoveSceneViewToBookmark2()
		{
			return BookmarkExists(2);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 3 #3", true)]
		private static bool ValidateMoveSceneViewToBookmark3()
		{
			return BookmarkExists(3);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 4 #4", true)]
		private static bool ValidateMoveSceneViewToBookmark4()
		{
			return BookmarkExists(4);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 5 #5", true)]
		private static bool ValidateMoveSceneViewToBookmark5()
		{
			return BookmarkExists(5);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 6 #6", true)]
		private static bool ValidateMoveSceneViewToBookmark6()
		{
			return BookmarkExists(6);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 7 #7", true)]
		private static bool ValidateMoveSceneViewToBookmark7()
		{
			return BookmarkExists(7);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 8 #8", true)]
		private static bool ValidateMoveSceneViewToBookmark8()
		{
			return BookmarkExists(8);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Move Scene View To Bookmark 9 #9", true)]
		private static bool ValidateMoveSceneViewToBookmark9()
		{
			return BookmarkExists(9);
		}

		[MenuItem("Conkist/Tools/Bookmark Scene View/Return To Previous Scene View #0", true)]
