...
namespace Conkist.GDK.Tools.Internal
{
	...
	public static class SelectionHistoryHotkeys
	{
		...
		private const string BackMenuLabel = "Conkist/Tools/Back In Selection History %#[";
		private const string ForwardMenuLabel = "Conkist/Tools/Forward In Selection History %#]";
