...
#region ErrorValues
        ...
        private readonly char[] invalidFilenameChars = { '$', '%', '&', '\\', '/', ':', '<', '>', '|', '~' };
#endif
        [MenuItem("Conkist/Tools/PlayerPrefs", false, 1)]
        ...
        private void OnEnable()
        {
            ...
            monitoring = EditorPrefs.GetBool("CCG.PlayerPrefs.WatchingForChanges", true);
            if(monitoring)
                entryAccessor.StartMonitoring();

            sortOrder = (PreferencesEntrySortOrder) EditorPrefs.GetInt("CCG.PlayerPrefs.SortOrder", 0);
        ...
        private void InitReorderedList()
        {
            ...
            relSpliterPos = EditorPrefs.GetFloat("CCG.PlayerPrefs.RelativeSpliterPosition", 100 / position.width);
        ...
        private void OnDrawElementBackgroundCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (Event.current.type == EventType.MouseUp)
            {
                ...
                EditorPrefs.SetFloat("CCG.PlayerPrefs.RelativeSpliterPosition", relSpliterPos);
            }
        }
        ...
        void OnGUI()
        {
            ...
            try
            {
                ...
                if (GUILayout.Button(sortOrderContent, EditorStyles.toolbarButton))
                {
                    ...
                    EditorPrefs.SetInt("CCG.PlayerPrefs.SortOrder", (int) sortOrder);
                    PrepareData(false);
                }
                ...
                if (GUILayout.Button(watcherContent, EditorStyles.toolbarButton))
                {
                    ...
                    EditorPrefs.SetBool("CCG.PlayerPrefs.WatchingForChanges", monitoring);
